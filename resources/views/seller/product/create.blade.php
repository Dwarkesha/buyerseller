...
<div class="container">
  <form id="frmAdd" method="post" action="{{url('/productcreate')}}" enctype="multipart/form-data">
        ...
        <div class="col-md-12 col-md-offset-4">
            <div class="col-md-3 upload-img-item">
                <div class="thumb-imgs">
                    <img src="" id="blah" alt="your image" class="img img-responsive" width="150px" height="auto">
                </div>
            </div>
        </div>
    </div>
